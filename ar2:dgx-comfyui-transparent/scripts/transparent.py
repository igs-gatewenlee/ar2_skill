...
_CONFIG_CANDIDATES = [
    Path.home() / ".claude/skills/ar2:dgx-comfyui-check/config.py",
    Path.home() / ".claude/skills/ar2:dgx-comfyui-gen/config.py",
    Path("/Users/gatewenlee/Code/ar2-skills/ar2:dgx-comfyui-check/config.py"),
    Path("/Users/gatewenlee/Code/ar2-skills/ar2:dgx-comfyui-gen/config.py"),
]
