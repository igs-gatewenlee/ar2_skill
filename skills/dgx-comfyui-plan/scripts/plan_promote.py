...
def promote(
    ...
    for line in text.splitlines()[:30]:
        print(line)
    print("\n--- next steps ---")
    # presets_dir = <repo>/skills/dgx-comfyui-plan/presets → repo root = parent×3.
    print(f"cd {presets_dir.parent.parent.parent}")
    print(f"git add skills/dgx-comfyui-plan/presets/{working_id}_outline.md")
